...
public class MainDB : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        AddPlayer(1, "Moshiya", "Ntokozo", "UCT UNI", "Physics", 24, 0);
...

    {
        ...
        using (var connection = new SqliteConnection(dbName))
        {
            ...
            using (var command = connection.CreateCommand())
            {
                ...
                command.CommandText = "CREATE TABLE IF NOT EXISTS player( Personid int, LastName varchar(255) , FirstName varchar(255), SchoolName varchar(255),Subject varchar(255), Age int,  Score int);";
                //command.CommandText = "CREATE TABLE IF NOT EXISTS quiz( QuestionID int, Question varchar(255), Answer varchar(255));";
    ...
    public void AddPlayer(int pID, string surname, string name, string schoolName, string subject, int age, int score)
    {
...

        {
            ...
            using (var command = connection.CreateCommand())
            {
                ...
                command.CommandText = "INSERT INTO player (Personid, LastName, FirstName, SchoolName, Subject, Age, Score) VALUES ('" + pID + "','" + surname + "','" + name + "','" + schoolName + "','" + subject + "','" + age + "','" + score + "');";
                command.ExecuteNonQuery(); //this runs the SQL
            }
            connection.Close();
        }
